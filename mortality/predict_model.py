...
def user_input_dash():
    ...
    app.layout = html.Div(
        [
            ...
            html.I(
                "A box plot is a graphical representation of dataset distribution:",
                style={
                    "textAlign": "left",
                    "fontFamily": "Arial, sans-serif",
                    "marginTop": "20px",
            ...
            html.P(
                " - The Box, which contains the middle 50% of the data, represents the interquartile ranges. The bottom of the box represents the first quartile, and the top represents the third quartile. The line inside the box marks the median (midpoint of the dataset)",
                style={
                    "textAlign": "left",
                    "fontFamily": "Arial, sans-serif",
                    "marginTop": "20px",
            ...
            html.P(
                " - The Whiskers: These lines extend from the box to the smallest and largest data points within a range. They help visualize the spread of the data.",
                style={
                    "textAlign": "left",
                    "fontFamily": "Arial, sans-serif",
                    "marginTop": "20px",
            ...
            html.P(
                " - Outliers: Data points beyond the whiskers are considered outliers, they indicate unusual values in the dataset.",
                style={
                    "textAlign": "left",
                    "fontFamily": "Arial, sans-serif",
                    "marginTop": "20px",
